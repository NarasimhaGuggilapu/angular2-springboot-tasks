...
@Configuration
@EnableJpaRepositories(basePackages = "com.narasimha.angular2springboot.repositories",
...
public class ApplicationDataSourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.narasimha.angular2springboot.model" });
